import { property as p, LitElement as q } from "lit-element";
...
var E = Object.defineProperty, c = (e, t, n, x) => {
  for (var s = void 0, i = e.length - 1, u; i >= 0; i--)
    (u = e[i]) && (s = u(t, n, s) || s);
  return s && E(t, n, s), s;
};
const r = {};
class d extends q {
  async getValidator(t, n) {
    ...
    if (r[n]) return r[n];
    const x = new Worker("public/js/worker.js");
    async function s(i, u) {
      return new Promise((a) => {
        x.addEventListener("message", (o) => {
          f(o.data) && o.data.file === u && a(o.data);
        }), x.postMessage({ content: i, name: u });
      });
    }
    return r[n] = s, new Promise((i, u) => {
      x.addEventListener("message", (a) => {
        if (C(a.data))
          a.data.loaded ? i(s) : u(m("validator.schema.loadEror", { name: a.data.file }));
        else if (v(a.data)) {
          const o = a.data.message.split(": ", 2), b = o[1] ? o[1] : o[0], T = o[1] ? " (" + o[0] + ")" : "";
          this.dispatchEvent(
            y({
              title: b,
              validatorId: this.pluginId,
              message: a.data.file + ":" + a.data.line + " " + a.data.node + " " + a.data.part + T
            })
          );
        } else f(a.data) || this.dispatchEvent(
          l({
      ...
      }), x.postMessage({ content: t, name: n });
    });
  }
  async validate() {
    const t = this.docName;
    let n = "2007", x = "B", s = "1";
    this.doc.documentElement && ([n, x, s] = [
